  ...
  render() {
    return (
      <div className={"textfield" + (this.props.inline ? ' inline' : '') + (this.props.large ? " large" : "") + (this.props.errorText ? " invalid" : "")}>
        <input name={this.props.label} id={this.props.id} placeholder={this.props.float ? '' : this.props.label} onKeyPress={this.props.onKeyPress} className={"textfield-input"} type={this.props.password ? 'password' : ''} value={this.props.value} onChange={this.props.handleChange} onFocus={this.focusOn} onBlur={this.focusOff}/>
